...
| `--l1-eth-rpc <URL>` | `KONA_NODE_L1_ETH_RPC` | URL of the L1 execution client RPC API | No | `http://localhost:8545` |
| `--l1-beacon <URL>` | `KONA_NODE_L1_BEACON` | URL of the L1 beacon API | No | `http://localhost:5052` |
| `--l2-engine-rpc <URL>` | `KONA_NODE_L2_ENGINE_RPC` | URL of the engine API endpoint of an L2 execution client | No | `http://localhost:8551` |
| `--l2-provider-rpc <URL>` | `KONA_NODE_L2_ETH_RPC` | An L2 RPC URL | No | `http://localhost:8546` |
