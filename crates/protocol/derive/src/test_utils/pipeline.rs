...
use crate::{
    ...
    Signal, SignalReceiver, TraversalProvider,
...
/// A [`TraversalProvider`] using test providers and sources.
pub type TestL1Traversal = TraversalProvider<TestChainProvider>;
